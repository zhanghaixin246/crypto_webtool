...
import (
	...
	"crypto_webtool/fabric/v2.2/common/genesis"
	"crypto_webtool/fabric/v2.2/common/policies"
	"crypto_webtool/fabric/v2.2/common/policydsl"
	"crypto_webtool/fabric/v2.2/common/util"
	"crypto_webtool/fabric/v2.2/internal-tools/configtxgen/genesisconfig"
	"crypto_webtool/fabric/v2.2/internal-tools/configtxlator/update"
...
func NewChannelGroup(conf *genesisconfig.Profile) (*cb.ConfigGroup, error) {
	...
	if err := AddPolicies(channelGroup, conf.Policies, channelconfig.AdminsPolicyKey); err != nil {
		fmt.Println("AddPolicies(channelGroup, conf.Policies, channelconfig.AdminsPolicyKey) : ",err)
	...
	if conf.Orderer != nil {
		...
		fmt.Println("NewOrdererGroup(conf.Orderer) :  err ",err)
		if err != nil {
	...
	if conf.Application != nil {
		...
		fmt.Println("NewApplicationGroup(conf.Application) : err :",err)
		if err != nil {
	...
	if conf.Consortiums != nil {
		...
		fmt.Println("NewConsortiumsGroup(conf.Consortiums) : err :",err)
		if err != nil {
...
func NewBootstrapper(config *genesisconfig.Profile) (*Bootstrapper, error) {
	...
	fmt.Println("channelGroup : err :",err)
	if err != nil {
