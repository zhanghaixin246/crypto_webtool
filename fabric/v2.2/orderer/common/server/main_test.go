...
import (
	...
	server_mocks "crypto_webtool/fabric/v2.2/orderer/common/server/mocks"
...
func TestMain(m *testing.M) {
	var err error
	cryptogen, err = gexec.Build("crypto_webtool/fabric/v2.2/cmd/cryptogen")
	if err != nil {
