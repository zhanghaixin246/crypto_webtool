...
import (
	...
	"crypto_webtool/fabric/v2.2/common/configtx"
	deliver_mocks "crypto_webtool/fabric/v2.2/common/deliver/mock"
	...
	cluster_mocks "crypto_webtool/fabric/v2.2/orderer/common/cluster/mocks"
	"crypto_webtool/fabric/v2.2/orderer/common/localconfig"
	onboarding_mocks "crypto_webtool/fabric/v2.2/orderer/common/onboarding/mocks"
...
func TestMain(m *testing.M) {
	var err error
	configtxgen, err = gexec.Build("crypto_webtool/fabric/v2.2/cmd/configtxgen")
	if err != nil {
